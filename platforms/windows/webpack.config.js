...
module.exports = {
    // your windows-specific entry file
    entry: path.resolve(appDirectory, './index.windows.js'),
    devtool: 'eval',
    ...
    output: {
        filename: 'bundle.js',
        publicPath: '/assets/',
        path: path.resolve(appDirectory, './platforms/windows/assets'),
    },
