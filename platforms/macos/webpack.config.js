...
module.exports = {
  // your macos-specific entry file
  entry: path.resolve(appDirectory, './index.macos.js'),
  devtool: 'eval',
  ...
  output: {
    filename: 'bundle.js',
    publicPath: '/assets/',
    path: path.resolve(appDirectory, './platforms/macos/assets')
  },
