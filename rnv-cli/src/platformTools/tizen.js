...
const copyTizenAssets = (c, platform) =>
    new Promise((resolve, reject) => {
...
const addDevelopTizenCertificate = c =>
    new Promise((resolve, reject) => {
...
const runTizen = (c, platform, target) =>
    new Promise((resolve, reject) => {
...
const configureTizenProject = (c, platform) =>
    new Promise((resolve, reject) => {
