...
const checkIfCommandExists = command =>
    new Promise((resolve, reject) =>
        child_process.exec(`command -v ${command} 2>/dev/null`, error => {
            if (error) return reject(new Error(`${command} not installed`));
            return resolve();
        })
    );

const runPod = (command, cwd, rejectOnFail = false) =>
    new Promise((resolve, reject) => {
...
const _runXcodeProject = (c, platform, target) =>
    new Promise((resolve, reject) => {
...
const prepareXcodeProject = (c, platform) =>
    new Promise((resolve, reject) => {
        const device = c.program.device;
...
const configureXcodeProject = (c, platform, ip, port) =>
    new Promise((resolve, reject) => {
...
const _postConfigureProject = (c, platform, appFolder, appFolderName, isBundled = false, ip = 'localhost', port = 8081) =>
    new Promise((resolve, reject) => {
...
const _preConfigureProject = (c, platform, appFolderName, ip = 'localhost', port = 8081) =>
    new Promise((resolve, reject) => {
...
const listAppleDevices = (c, platform) =>
    new Promise((resolve, reject) => {
...
const launchAppleSimulator = (c, platform, target) =>
    new Promise((resolve, reject) => {
