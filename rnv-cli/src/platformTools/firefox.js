...
const launchKaiOSSimulator = (c, name) =>
    new Promise((resolve, reject) => {
        ...
        if (!c.globalConfig.sdks.KAIOS_SDK) {
            reject(
                `${KAIOS_SDK} is not configured in your ~/.rnv/config.json file. Make sure you add location to your Kaiosrt App path similar to: ${chalk.white.bold(
...
const copyKaiOSAssets = (c, platform) =>
    new Promise((resolve, reject) => {
...
const configureKaiOSProject = (c, platform) =>
    new Promise((resolve, reject) => {
...
const runFirefoxProject = (c, platform) =>
    new Promise((resolve, reject) => {
...
const buildFirefoxProject = (c, platform) =>
    new Promise((resolve, reject) => {
