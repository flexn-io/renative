...
export default async function getBaseWebpackConfig(
  ...
  const resolveConfig = {
    ...
    alias: {
      ...
      'next/head': '@rnv/next/dist/next-server/lib/head.js',
      'next/router': '@rnv/next/dist/client/router.js',
      'next/config': '@rnv/next/dist/next-server/lib/runtime-config.js',
      'next/dynamic': '@rnv/next/dist/next-server/lib/dynamic.js',
