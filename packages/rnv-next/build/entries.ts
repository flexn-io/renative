...
export function createPagesMapping(
  ...
  pages['/_app'] = pages['/_app'] || '@rnv/next/dist/pages/_app'
  pages['/_error'] = pages['/_error'] || '@rnv/next/dist/pages/_error'
  pages['/_document'] = pages['/_document'] || '@rnv/next/dist/pages/_document'
