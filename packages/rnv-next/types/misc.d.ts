...
declare module '@rnv/next/dist/compiled/nanoid/index.js' {
  function nanoid(size?: number): string

  export = nanoid
}

declare module '@rnv/next/dist/compiled/unistore' {
  import unistore from 'unistore'
  export = unistore
}

declare module '@rnv/next/dist/compiled/resolve/index.js' {
  import resolve from 'resolve'

  export = resolve
}

declare module '@rnv/next/dist/compiled/text-table' {
  function textTable(
    rows: Array<Array<{}>>,
    opts?: {
      hsep?: string
...
declare module '@rnv/next/dist/compiled/arg/index.js' {
