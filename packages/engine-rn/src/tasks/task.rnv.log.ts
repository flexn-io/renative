import { logErrorPlatform, logTask, PARAMS, RnvTaskFn, executeTask, RnvTask, TASK_LOG } from '@rnv/core';
...
import { TASK_PROJECT_CONFIGURE, TASK_WORKSPACE_CONFIGURE } from './constants';
