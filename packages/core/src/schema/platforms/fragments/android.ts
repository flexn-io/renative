...
export const zodPlatformAndroidFragment = z.object({
    ...
    excludedFeatures: z.array(z.string()).describe('Override features definitions in AndroidManifest.xml by exclusion'),
    includedFeatures: z.array(z.string()).describe('Override features definitions in AndroidManifest.xml by inclusion'),
    buildToolsVersion: z.string().default(DEFAULTS.buildToolsVersion).describe('Override android build tools version'),
