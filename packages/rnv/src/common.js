...
//     if (aPath.startsWith('@')) {
//         if (!aPath.includes('/')) throw new Error(`Scoped packages must include subpackage portion e.g. '@aScope/subpackage'. Supplied path: ${aPath}`)
//         return true
//     }
// }
...
export const waitForWebpack = async c => {
    ...
    const devServerHost = getValidLocalhost(
