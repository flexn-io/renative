window.webOSDev = (function(e) {
    ...
    function(e, t, r) {
        ...
        var o =
            ...
            s = (t.LS2Request = (function() {
                function e() {
                    n(this, e), (this.bridge = null), (this.cancelled = !1), (this.subscribe = !1);
                }
                return (
                    i(e, [
                        {
                            ...
                            value: function(e) {
                                ...
                                if (!window.PalmServiceBridge) {
                                    ...
                                    return v(y), p(y), console.error('PalmServiceBridge is not found.'), this;
                                }
                                this.ts && a[this.ts] && delete a[this.ts];
                                var O = o({}, c);
                                return (
                                    (this.subscribe = b),
                                    ...
                                    (this.bridge.onservicecallback = this.callback.bind(this, d, v, p)),
                                    this.bridge.call(u(r) + i, JSON.stringify(O)),
                                    this
                                );
                            },
                        },
                            ...
                            value: function() {
                                ...
                                if (!this.cancelled) {
                                    ...
                                    var i = o,
                                        a = i.errorCode,
                                        u = i.returnValue;
                                    void 0 !== a || !1 === u ? ((o.returnValue = !1), t(o)) : ((o.returnValue = !0), e(o)),
                                        r(o),
    ...
    function(e, t, r) {
        ...
        Object.defineProperty(t, '__esModule', { value: !0 }), (t.drmAgent = t.DRM = void 0);
        var o =
                Object.assign ||
                function(e) {
                    for (var t = 1; t < arguments.length; t++) {
            ...
            c = { PLAYREADY: 'playready', WIDEVINE: 'widevine', VERIMATRIX: 'viewrights_web' },
            l = { UNLOADED: 0, LOADING: 1, LOADED: 2, UNLOADING: 3 },
            d = function(e) {
                var t = e.method,
                    r = e.parameters,
                    n = e.onComplete;
                new u.LS2Request().send({ service: 'luna://com.webos.service.drm', onComplete: n, method: t, parameters: r });
            },
            f = function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : function() {},
                    t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            ...
            v = function(e) {
                return e.state === l.LOADED && '' !== e.getClientId();
            },
            h = function(e, t) {
                var r = t.errorCode,
                    n = void 0 === r ? s.UNKNOWN_ERROR : r,
                    o = t.errorText,
                    i = void 0 === o ? 'Unknown error.' : o,
                    a = { errorCode: n, errorText: i };
                return e.setError(a), a;
            },
            p = function(e) {
                var t = '',
                    r = '';
                ...
                return { msgType: t, drmSystemId: r };
            },
            m = { errorCode: s.CLIENT_NOT_LOADED, errorText: 'DRM client is not loaded.' },
            b = (function() {
                function e(t) {
                    n(this, e),
                        (this.clientId = ''),
                    ...
                    i(e, [
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                ...
                                d({
                                    method: 'isLoaded',
                                    parameters: { appId: (0, a.fetchAppId)() },
                                    onComplete: function(e) {
                                        if (!0 === e.returnValue) {
                                            if (
                                                ((t.clientId = e.clientId || ''),
                                                (t.state = e.loadStatus ? l.LOADED : l.UNLOADED),
                                                !0 === e.loadStatus && e.drmType !== t.drmType)
                                            ) {
                                                var r = {
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                ...
                                if (this.state === l.LOADING || this.state === l.LOADED)
                                    return void f(n, { isLoaded: !0, clientId: this.clientId });
                                    ...
                                    d({
                                        ...
                                        onComplete: function(e) {
                                            return !0 === e.returnValue
                                                ? ((t.clientId = e.clientId), (t.state = l.LOADED), n({ clientId: t.clientId }))
                                                : i(h(t, e));
                                        },
                                        parameters: u,
                                    });
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                ...
                                (this.state = l.UNLOADING),
                                    d({
                                        method: 'unload',
                                        onComplete: function(e) {
                                            return !0 === e.returnValue
                                                ? ((t.clientId = ''), (t.state = l.UNLOADED), n())
                                                : i(h(t, e));
                                        },
                                        parameters: a,
                                    });
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                ...
                                var c = p(this.drmType),
                                    l = o({ clientId: this.clientId, msg: n }, c);
                                d({
                                    method: 'sendDrmMessage',
                                    onComplete: function(e) {
                                        if (!0 === e.returnValue) {
                                            var r = o({}, e);
                                            return delete r.returnValue, a(r);
                                        }
                                        return s(h(t, e));
                                    },
                                    parameters: l,
            ...
            o = function(e) {
                ...
                new n.LS2Request().send({
                    ...
                    onComplete: function(e) {
                        ...
                        i({ errorCode: e.errorCode, errorText: e.errorText });
                    },
                });
            };
        t.default = o;
    ...
    function(e, t, r) {
        ...
        var n =
            ...
            o = r(0),
            i = (t.APP = { BROWSER: 'APP_BROWSER' }),
            a = function(e) {
                var t = e.parameters,
                    r = e.onSuccess,
                    n = e.onFailure;
                new o.LS2Request().send({
        ...
        (t.launch = function(e) {
            var t = e.id,
                ...
                d = void 0 === l ? function() {} : l,
                f = n({}, { id: r, params: u });
            i.BROWSER === r && ((f.params.target = u.target || ''), (f.params.fullMode = !0), (f.id = 'com.webos.app.browser')),
                a({ parameters: f, onSuccess: c, onFailure: d });
        }),
            (t.launchParams = function() {
                var e = {};
            ...
            a = {
                getStatus: function(e) {
                    var t = e.onSuccess,
                        ...
                        u = void 0 !== a && a,
                        s = 'webos.service';
                    navigator.userAgent.indexOf('537.41') > -1 && (s = 'palm'),
                        i({ service: 'luna://com.' + s + '.connectionmanager', subscribe: u, onSuccess: r, onFailure: o });
                },
            };
        t.default = a;
    },
    ...
    function(e, t, r) {
        ...
        Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.LGUDID = t.launchParams = t.launch = t.drmAgent = t.DRM = t.connection = t.APP = void 0);
        var o = r(3),
            i = r(1),
            a = r(4),
            u = n(a),
            ...
            c = n(s);
        (t.APP = o.APP),
            (t.connection = u.default),
            (t.DRM = i.DRM),
            (t.drmAgent = i.drmAgent),
            (t.launch = o.launch),
            (t.launchParams = o.launchParams),
            (t.LGUDID = c.default);
    },
]);
