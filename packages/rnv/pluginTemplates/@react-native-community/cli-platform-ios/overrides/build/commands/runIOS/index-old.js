...
const _warnAboutManuallyLinkedLibs = _interopRequireDefault(require('../../link/warnAboutManuallyLinkedLibs'));

const _warnAboutPodInstall = _interopRequireDefault(require('../../link/warnAboutPodInstall'));
...
function runIOS(_, ctx, args) {
    ...
    const udid = '3862004A-DCA3-457B-9F74-7761A5D59E95';
...
async function runOnSimulator(xcodeProject, scheme, args) {
   ...
   */
    ...
    const selectedSimulator = fallbackSimulators.reduce((simulator, fallback) => simulator || (0, _findMatchingSimulator.default)(simulators, fallback), (0, _findMatchingSimulator.default)(simulators, args.simulator));
...
function buildProject(xcodeProject, udid, scheme, args) {
    return new Promise((resolve, reject) => {
        ...
        buildProcess.stdout.on('data', (data) => {
            ...
            } else if (_cliTools().logger.isVerbose()) {
