...
console.log(`
    ...
    `);process.exit(0);}const dir=(0,_path.resolve)(args._[0]||'.');args['--pagesDir']&&(0,_findPagesDir.setPagesDir)((0,_path.join)(dir,args['--pagesDir']));// Check if pages dir exists and warn if not
