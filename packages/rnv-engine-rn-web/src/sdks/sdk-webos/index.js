...
import { Exec, SDKWebpack, FileUtils, Common, Logger, Constants, TargetManager, PlatformManager, Utils, ProjectManager } from 'rnv';

const { fsExistsSync, getRealPath, writeCleanFile, fsReadFileSync } = FileUtils;
const { executeAsync, execCLI, openCommand } = Exec;
const {
...
const { isSystemWin, isUrlLocalhost } = Utils;
