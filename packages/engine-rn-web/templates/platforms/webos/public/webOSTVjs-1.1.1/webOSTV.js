            ...
            P = function (e) {
                if (0 === Object.keys(S).length) {
                    try {
                        ...
                        (S.modelName = n.modelName),
                            (S.version = n.platformVersion),
                            (S.versionMajor = n.platformVersionMajor),
                            (S.versionMinor = n.platformVersionMinor),
                            (S.versionDot = n.platformVersionDot),
                            (S.sdkVersion = n.platformVersion),
                            (S.screenWidth = n.screenWidth),
                            (S.screenHeight = n.screenHeight);
                    } catch (e) {
                        ...
                        g.tv &&
                            new m().send({
                                ...
                                onSuccess: function (n) {
                                    if (
                                        ((S.modelName = n.modelName || S.modelName),
                                        (S.sdkVersion = n.sdkVersion || S.sdkVersion),
                                        (S.uhd = 'true' === n.UHD),
                                        ...
                                        for (
                                            var r = S.version.split('.'),
                                                t = ['versionMajor', 'versionMinor', 'versionDot'],
                                                o = 0;
                                            o < t.length;
                                            o += 1
                                        )
