...
export const parseAppBuildGradleSync = () => {
    ...
    c.payload.pluginConfigAndroid.ndkVersion = getConfigProp('ndkVersion') || '27.1.12297006';
...
export const parseGradlePropertiesSync = () => {
    ...
    const reactNativeEngine = getConfigProp('reactNativeEngine') || 'hermes';
    const _enableJetifier = getConfigProp('enableJetifier');
    const enableJetifier = _enableJetifier !== null && _enableJetifier !== undefined ? _enableJetifier : true;
